...
interface NewsSource {
    ...
    suspend fun sendNews(headerText: String, text: String? = null, images: List<String>? = null,
                         voices: List<String>? = null, files: List<String>? = null) : String

    suspend fun getNews(pageIndex: Int, pageSize: Int) : List<News>

    suspend fun editNews(newsId: Int, headerText: String, text: String? = null, images: List<String>? = null,
                         voices: List<String>? = null, files: List<String>? = null) : String
