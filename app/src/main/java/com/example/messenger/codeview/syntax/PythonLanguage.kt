...
object PythonLanguage {
    ...
    private val PATTERN_OPERATION: Pattern =
        Pattern.compile(":|==|>|<|!=|>=|<=|->|=|%|-|-=|%=|\\+|\\+=|\\^|&|\\|::|\\?|\\*")
    private val PATTERN_HASH_COMMENT: Pattern = Pattern.compile("#(?!TODO )[^\\n]*")
    ...
    fun applyMonokaiTheme(context: Context, codeView: CodeView) {
        ...
        codeView.addSyntaxPattern(PATTERN_HASH_COMMENT, context.getColorCompat(R.color.monokia_pro_grey))
    ...
    fun applyNoctisWhiteTheme(context: Context, codeView: CodeView) {
        ...
        codeView.addSyntaxPattern(PATTERN_HASH_COMMENT, context.getColorCompat(R.color.noctis_grey))
    ...
    fun applyFiveColorsDarkTheme(context: Context, codeView: CodeView) {
        ...
        codeView.addSyntaxPattern(PATTERN_HASH_COMMENT, context.getColorCompat(R.color.five_dark_grey))
    ...
    fun getKeywords(context: Context): Array<String> {
        return context.resources.getStringArray(R.array.python_keywords)
    }
